        ...
        <section className="min-h-screen mx-auto container_ ">
            ...
            >
                ...
                <button className="hidden md:block animate-bounce px-8 py-4 bg-[white] rounded z-10 text-[#1E3A85] hover:animate-none text-xl hover:bg-[#1E3A85] hover:text-white transition-all active:scale-100 duration-300 cursor-pointer">
                    <a href='https://wa.me/996221158535?text=Здравствуйте,%20хочу%20получить%20подробнее!' target='_blank'>Забронировать тур</a>
                </button>
                <button onClick={() => ScrollDown()} className='p-1 z-10 absolute bottom-0 left-1/2 -translate-x-1/2 duration-300  transition-all cursor-pointer hover:-translate-y-1/3 group hover:bg-[#1E3A85] background-opacity-30 rounded-full '>
